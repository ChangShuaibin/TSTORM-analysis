...
class TifReader(Reader):
    ...
    def __init__(self, filename):
        ...
        if (len(self.isize) == 3):
            self.frames_per_page = self.isize[2]
...
if (__name__ == "__main__"):
    ...
    file=TifReader('/home/nauge/TSTORM/BigTIFFSamples/BigTIFF.tif')
    print(file.isize)
    print(file.image_height)
    print(file.number_frames)
    print(file.frames_per_page)
    data=file.loadAFrame(2)
    print(data)